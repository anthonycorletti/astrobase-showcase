...
```sh
$ astrobase apply -f resources.yaml -v "EKS_LOCATION=us-east-1 GKE_LOCATION=us-central1 NGINX_CONTAINER_PORT=80 NGINX_MEM_REQUEST=64Mi NGINX_CPU_REQUEST=250m NGINX_MEM_LIMIT=128Mi NGINX_CPU_LIMIT=500m"
